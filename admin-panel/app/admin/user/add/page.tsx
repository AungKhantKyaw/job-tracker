...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  card: { backgroundColor: "#fff", padding: "40px", borderRadius: "16px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1)" },
  ...
  select: { padding: "12px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "15px", backgroundColor: "#fff" },
  helpText: { fontSize: "12px", color: "#9ca3af", marginTop: "4px" },
  actions: { display: "flex", justifyContent: "flex-end", gap: "12px", marginTop: "10px" },
  cancelBtn: { padding: "12px 20px", borderRadius: "8px", border: "1px solid #d1d5db", backgroundColor: "#fff", cursor: "pointer", fontWeight: "600" },
  submitBtn: { padding: "12px 24px", borderRadius: "8px", border: "none", backgroundColor: "#2563eb", color: "#fff", cursor: "pointer", fontWeight: "600" },
  error: { padding: "12px", backgroundColor: "#fee2e2", color: "#b91c1c", borderRadius: "8px", marginBottom: "20px", fontSize: "14px" },
};
